...
import { HERO_ROLES, HERO_TICKER, PROFILE } from "./constants";
...
export const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-x-0 bottom-16 h-24 bg-gradient-to-t from-[#0A0A0A] to-transparent z-[1]" />
      ...
      >
        ...
        >
          <span className="inline-block w-2 h-2 bg-[#00E5FF] rounded-full timeline-dot" />
        ...
        >
          <span className="block">
            ...
            <span
              ...
              style={{ animationDelay: `${0.25 + nameLetters.length * 0.06}s` }}
            >
              .
            </span>
          </span>
        ...
        >
          ...
          <span className="text-white">
            {PROFILE.years} years architecting distributed systems for products used by millions.
          </span>
        </p>
        ...
        >
          ...
          <span className="ml-2 font-mono text-[11px] uppercase tracking-[0.25em] text-white/40 hidden md:inline-flex items-center gap-2">
            ...
            or press
            <kbd className="px-1.5 py-0.5 border border-white/15 text-white/60">⌘</kbd>
            <kbd className="px-1.5 py-0.5 border border-white/15 text-white/60">K</kbd>
          </span>
        </div>
        ...
        <div className="absolute -bottom-24 right-6 md:right-12 hidden lg:flex flex-col items-end gap-2 font-mono text-[10px] uppercase tracking-[0.3em] text-white/40">
          <span>Scroll</span>
          <span className="h-16 w-px bg-gradient-to-b from-[#00E5FF] to-transparent" />
        </div>
      </div>
