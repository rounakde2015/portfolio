  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-6 md:px-12">
        <SectionHeading index="01" label="About" title="Engineer. Architect. Builder." />
        <div className="grid md:grid-cols-5 gap-12 md:gap-20">
          <div className="md:col-span-3 space-y-6 reveal">
            <p className="text-lg md:text-xl text-[#F4F4F5] font-light leading-relaxed">
              ...
              <span className="text-[#00E5FF]">{PROFILE.years} years</span> shipping production
              software at companies that don&apos;t get to fail — payments, observability,
              marketplaces.
            </p>
            <p className="text-base md:text-lg text-[#A1A1AA] font-light leading-relaxed">
              I think in tradeoffs: throughput vs latency, consistency vs availability, velocity vs
              stability. I&apos;ve designed systems that scaled from prototype to billions of
              requests, mentored teams from 3 to 30, and rolled back enough deploys to know when to
              ship and when to wait.
            </p>
            <p className="text-base md:text-lg text-[#A1A1AA] font-light leading-relaxed">
              My work spans the stack — from React frontends used by millions, to JVM services
              orchestrating cross-region replication, to infrastructure-as-code provisioning
              multi-cloud topologies. Pragmatic, opinionated, and obsessed with the details that
              ship.
            </p>
            <div className="pt-4">
              <a
